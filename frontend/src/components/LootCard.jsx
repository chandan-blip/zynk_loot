  ...
  return (
    ...
    >
      ...
      <div className="absolute top-3 right-3 z-10 flex gap-1.5 flex-wrap justify-end">
        ...
        {!matchesRevealed && (status === 'would_lose' || (isVirtual && !matchesRevealed)) && (
        ...
        {(isVirtual || !owner) && !isOwned && matchesRevealed && status !== 'would_lose' && (
      ...
      {(status === 'lost' || status === 'cashed_out') ? (
        <div className="flex items-center justify-center text-xs">
          {status === 'lost' ? (
            <span className="text-red-400/70">This ticket did not match the winning number</span>
          ) : (
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex-shrink-0">
              {isOwned && matchedDigits > 0 ? (
                <RadialChart percentage={(matchedDigits / 7) * 100} size={56} strokeWidth={4} />
              ) : (
              ...
              {isOwned && matchedDigits > 0 ? (
                <>
                  ...
                  <div className="flex items-center gap-1.5 p-2 rounded-lg bg-accent/10 border border-accent/20">
                    ...
                    <div>
                      <p className="text-accent font-bold text-xs">{matchedDigits}/7</p>
                  ...
                  <div className="flex items-center gap-1.5 p-2 rounded-lg bg-purple/10 border border-purple/20">
                    ...
                    <div>
                      <p className="text-purple-light font-bold text-xs">{multiplier || MULTIPLIER_MAP[matchedDigits]}x</p>
                  ...
                  <div className="col-span-1 sm:col-span-2 xl:col-span-1 flex items-center gap-1.5 p-2 rounded-lg bg-gold/10 border border-gold/20">
                    ...
                    <div>
                      <p className="text-gold-light font-bold text-sm">{currentReturn || ((buyAmount || price) * (multiplier || MULTIPLIER_MAP[matchedDigits]))} Z</p>
          ...
          status === 'lost' ? (
            ...
            <>
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  onCashOut?.(id, number, currentReturn || ((buyAmount || price) * (multiplier || MULTIPLIER_MAP[matchedDigits])));
                }}
